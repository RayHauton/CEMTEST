...
<div class="navBody">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse">
		<ul class="nav navbar-nav">
			<li class="dropdown"><a data-toggle="dropdown"
				class="dropdown-toggle" href="#">数据管理<b class="caret"></b></a>
				<ul role="menu" class="dropdown-menu">
					<li><a
						href="${pageContext.request.contextPath }/alumiAssociation/open_adm.action">校友会信息</a></li>
					<li><a
						href="${pageContext.request.contextPath }/collegeEvent/show_adm.action">学院事件录</a></li>
					<li><a
						href="${pageContext.request.contextPath }/majorSet/open_adm.action">学历管理</a></li>
					<li><a
						href="${pageContext.request.contextPath }/adminSurveySys/open_adm.action">调研信息</a></li>
				</ul></li>
			<li class="dropdown"><a data-toggle="dropdown"
				class="dropdown-toggle fontColor1" href="#">公告管理<b class="caret"></b></a>
				<ul role="menu" class="dropdown-menu">
					<li><a href="#">新闻公告</a></li>
					<li><a
						href="${pageContext.request.contextPath }/donation/open_adm.action">捐款公告</a></li>
				</ul></li>
			<li class="dropdown"><a data-toggle="dropdown"
				class="dropdown-toggle" href="#">系统管理<b class="caret"></b></a>
				<ul role="menu" class="dropdown-menu">
					<li><a href="#">论坛审核</a></li>
					<li><a href="#">祝福模板</a></li>
					<li><a
						href="${pageContext.request.contextPath }/userManage/open.action">用户管理</a></li>
					<li><a href="#">用户审核</a></li>
				</ul></li>
