...
<body>
	...
	<div class="wholepage">
			...
			<div class="container-fluid">
				...
				<div>
					<ul class="nav navbar-nav">
						...
						<li><a
							href="${pageContext.request.contextPath }/mail/mailToDept.jsp">发给指定专业</a></li>
						<li class="active"><a
							href="${pageContext.request.contextPath }/mail/mailToClass.jsp">发给指定班级</a></li>
					</ul>
				</div>
			</div>
			</nav>
		...
		<div class="">
			<form id="form"
				action="${pageContext.request.contextPath }/mail/mailToClass"
				method="post" enctype="multipart/form-data">
				<div class="input-group">
					<span class="input-group-addon">收件人</span> <input type="text"
						id="toList" name="toList" class="form-control"
						placeholder="请输入班级号码，如14级信管班为14201；多班级请用逗号隔开" >
				</div>
				<br>
				<div class="input-group">
