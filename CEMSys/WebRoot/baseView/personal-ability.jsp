						...
						<table id="SelfabilityqualityTable" class="table table-striped" style="width:70%">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="radio" id="27" name="companyCooperation"
										value="1"></td>
									<td><input type="radio" id="27" name="companyCooperation"
										value="2"></td>
									<td><input type="radio" id="27" name="companyCooperation"
								...
								<tr>
									...
									<td><input type="radio" id="28" name="professionalism"
										value="1"></td>
									<td><input type="radio" id="28" name="professionalism"
										value="2"></td>
									<td><input type="radio" id="28" name="professionalism"
								...
								<tr>
									...
									<td><input type="radio" id="29" name="majorBaseKnowledge"
										value="1"></td>
									<td><input type="radio" id="29" name="majorBaseKnowledge"
										value="2"></td>
									<td><input type="radio" id="29" name="majorBaseKnowledge"
								...
								<tr>
									...
									<td><input type="radio" id="30" name="knowledgeWidth"
										value="1"></td>
									<td><input type="radio" id="30" name="knowledgeWidth"
										value="2"></td>
									<td><input type="radio" id="30" name="knowledgeWidth"
								...
								<tr>
									...
									<td><input type="radio" id="31" name="foreignLanguage"
										value="1"></td>
									<td><input type="radio" id="31" name="foreignLanguage"
										value="2"></td>
									<td><input type="radio" id="31" name="foreignLanguage"
								...
								<tr>
									...
									<td><input type="radio" id="33" name="selfDealProblem"
										value="1"></td>
									<td><input type="radio" id="33" name="selfDealProblem"
										value="2"></td>
									<td><input type="radio" id="33" name="selfDealProblem"
								...
								<tr>
									...
									<td><input type="radio" id="34" name="practiceAndHandsOn"
										value="1"></td>
									<td><input type="radio" id="34" name="practiceAndHandsOn"
										value="2"></td>
									<td><input type="radio" id="34" name="practiceAndHandsOn"
								...
								<tr>
									...
									<td><input type="radio" id="35" name="motivationAbility"
										value="1"></td>
									<td><input type="radio" id="35" name="motivationAbility"
										value="2"></td>
									<td><input type="radio" id="35" name="motivationAbility"
								...
								<tr>
									...
									<td><input type="radio" id="37" name="wordsExpression"
										value="1"></td>
									<td><input type="radio" id="37" name="wordsExpression"
										value="2"></td>
									<td><input type="radio" id="37" name="wordsExpression"
						...
						<table  class="table table-striped" style="width:70%">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="radio" id="42"
										name="teacherTeachingLevel" value="1"></td>
									<td><input type="radio" id="40"
								...
								<tr>
									...
									<td><input type="radio" id="44" name="baseCourseLearning"
										value="1"></td>
									<td><input type="radio" id="44" name="baseCourseLearning"
										value="2"></td>
									<td><input type="radio" id="44" name="baseCourseLearning"
								...
								<tr>
									...
									<td><input type="radio" id="45" name="majorCourseLearning"
										value="1"></td>
									<td><input type="radio" id="45" name="majorCourseLearning"
										value="2"></td>
									<td><input type="radio" id="45" name="majorCourseLearning"
								...
								<tr>
									...
									<td><input type="radio" id="46" name="majorExperiment"
										value="1"></td>
									<td><input type="radio" id="46" name="majorExperiment"
										value="2"></td>
									<td><input type="radio" id="46" name="majorExperiment"
								...
								<tr>
									...
									<td><input type="radio" id="47" name="majorInternship"
										value="1"></td>
									<td><input type="radio" id="47" name="majorInternship"
										value="2"></td>
									<td><input type="radio" id="47" name="majorInternship"
								...
								<tr>
									...
									<td><input type="radio" id="48" name="graduationDesign"
										value="1"></td>
									<td><input type="radio" id="48" name="graduationDesign"
										value="2"></td>
									<td><input type="radio" id="48" name="graduationDesign"
