	...
	<table>
		...
		<div id="content">
			...
			<div id="Selfabilityquality">
				<p style="width: 998px; font-size: 18px; margin: 0 auto;"
					align="middle" id="SelfabilityqualityP">
				...
				<form action="" id="SelfabilityqualityForm">
					<table id="SelfabilityqualityTable" class="table table-striped"
						style="width: 1000px">
						<h2 id="SelfabilityqualityH2" style="margin-top: 0px"
							align="center">个人能力品质调研</h2>
						<tbody>
							<tr class="border-top">
					...
					<div class="btn" id="SelfabilityqualityBtn"
					...
					<table class="table table-striped" style="width: 1000px">
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="radio" id="15" name="teacherTeachingLevel"
									value="1"></td>
								<td><input type="radio" id="15" name="teacherTeachingLevel"
									value="2"></td>
								<td><input type="radio" id="15" name="teacherTeachingLevel"
							...
							<tr>
								...
								<td><input type="radio" id="24" name="textbookUsed"
									value="1"></td>
								<td><input type="radio" id="24" name="textbookUsed"
									value="2"></td>
								<td><input type="radio" id="24" name="textbookUsed"
							...
							<tr>
								...
								<td><input type="radio" id="28" name="physicalFitness"
									value="1"></td>
								<td><input type="radio" id="28" name="physicalFitness"
									value="2"></td>
								<td><input type="radio" id="28" name="physicalFitness"
							...
							<tr>
								...
								<td><input type="radio" id="30" name="libraryEffect"
									value="1"></td>
								<td><input type="radio" id="30" name="libraryEffect"
									value="2"></td>
								<td><input type="radio" id="30" name="libraryEffect"
							...
							<tr>
								...
								<td><input type="radio" id="31" name="instructorWorking"
									value="1"></td>
								<td><input type="radio" id="31" name="instructorWorking"
									value="2"></td>
								<td><input type="radio" id="31" name="instructorWorking"
							...
							<tr>
								...
								<td><input type="radio" id="35" name="psychologyGrooming"
									value="1"></td>
								<td><input type="radio" id="35" name="psychologyGrooming"
									value="2"></td>
								<td><input type="radio" id="35" name="psychologyGrooming"
							...
							<tr>
								...
								<td><input type="radio" id="36" name="tutorGuidance"
									value="1"></td>
								<td><input type="radio" id="36" name="tutorGuidance"
									value="2"></td>
								<td><input type="radio" id="36" name="tutorGuidance"
							...
							<tr>
								...
								<td><input type="radio" id="37" name="projectExperience"
									value="1"></td>
								<td><input type="radio" id="37" name="projectExperience"
									value="2"></td>
								<td><input type="radio" id="37" name="projectExperience"
